...
class SimpleAR:
    def __init__(self, camDevice):
        ...
        file_path = '/home/'+self.user_name+'/transbot_ws/src/transbot_program'
        if camDevice=="Astra": camerayaml_path = file_path + "/yaml/USB_camera.yaml"
        else: camerayaml_path = file_path + "/yaml/astra.yaml"
