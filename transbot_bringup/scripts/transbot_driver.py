...
class transbot_driver:
    def __init__(self):
        ...
        # self.bot.set_uart_servo_angle(2, 180)
        self.bot.set_pwm_servo(2, 120)
    ...
    def cmd_vel_callback(self, msg):
        ...
        # Ð¡³µÔË¶¯¿ØÖÆ,velocity=[-0.45, 0.45], angular=[2, 2]
