...
class M_Tracker:
    def __init__(self):
        ...
        self.limit = 80
        self.key_map = {114: lambda: self.Reset(),113: lambda: self.cancel()}
    ...
    def process(self, rgb_img, action):
        ...
        if self.Track_state == 'tracking':
            ...
            if self.circle[2] != 0: 
                ...
                self.bot.set_uart_servo_angle_array(angle[0],angle[1],180)
            ...
            if self.point_pose[0] != 0 and self.point_pose[1] != 0:
                ...
                self.bot.set_uart_servo_angle_array(angle1+30,135,180)
